const Projects = {
    Details:{//adding in opposite-chronological order, so it's easy to add later    
        ...
        WorkInProgress: {
            ...
            LargeDescription: "Best thing is to keep working on something new",
            NoOfProjectImages: 1
        },
        TileVisualiser: {
            ID: "TileVisualiser",
        ...
        ShiroDash: {
            ID: "ShiroDash",
            Name: "Shiro Dash",
            SmallDescription: "Android, Infinite-Runner, C#",
            LargeDescription: "",
            DownloadLink: "",
            EmbedVideoLinkID: "",
            NoOfProjectImages: 2
