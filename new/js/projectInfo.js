const Projects = {
    Details:{//adding in opposite-chronological order, so it's easy to add later    
        ...
        ShiroDash: {
            ...
            LargeDescription: "2D Infinite runner with jump and dash mechanics in Unity3D and C# for Android. Platforms are autogenerated with tweakable values of distance given to designers. Speed of the character increases with respect to time based on formula provided by the designers.",
        ...
        Homography: {
            ID: "Homography",
            Name: "Reactive Display for Virtual Reality",
