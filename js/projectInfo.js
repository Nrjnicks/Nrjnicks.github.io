const Projects = {
    Details: {//adding in opposite-chronological order, so it`s easy to add later    
        ...
        MobileFarm: {
            ...
            Keywords: "GooglePlay, iTunes, Windows, Samsung, Huawei, Amazon",
            ...
            <li>Game is live on GooglePlay, iTunes, Windows, SamsungPay, Huawei AppGalery, Amazon store</li>
        ...
        StarcademyBioform: {
            ...
            Keywords: "Android, iOS, AI, Programmer",
            Description: `<ul>
            <li>Used Intellectual Property characters to build game aiming to teach biology for iOS platform using Unity3D and C# (VS code IDE)</li>
            <li>In-charge of builds and debugging of Android platform. Used Git version control on Source Tree and Fork</li>
            <li>Built in-game alert, gyro camera mini-game, special skills, weapons auto-toggle, status and hit VFX system</li>
            <li>Adept in AI, 3Cs, Animations, UI, Shader Graph, Debugging, Optimization and Scriptable Render Pipeline</li>
            </ul>`,
            NoOfProjectImages: 0
        },
        TileVisualiser: {
            ...
            Keywords: "Shaders, Occulus Go, VR, UI, Unity3D, Freelancing",
            Description: `<ul> 
            <li>Wrote Surface Shader from scratch in Cg/HLSL (Unity3D) for VR Occulus Go build with runtime editable patterns</li> 
            <li>Proposed most optimised way to approach a problem keeping in mind the target platform and runtime cost</li>
            <li>Created in-game VR UI to nagivate through all patterns and combos</li>
            </ul>`,
            MoreInfoLink: "",
            NoOfProjectImages: 0
        },
        ShiroDash: {
            ID: "ShiroDash",
            Name: "Shiro Dash",
            Keywords: "Published Android Game, 2D, C#, Part-time",
            Description: `<ul> 
        ...
        Homography: {
            ...
            Keywords: "ISMAR 2017 (IEEE Publication), Academic Project",
        ...
        NearbyConnections: {
            ...
            Keywords: "Android API, C#, java, Bluetooth, Internship",
